...
,p_default_application_id=>99838
...
prompt APPLICATION 99838 - Mobile Application
--
-- Application Export:
--   Application:     99838
--   Name:            Mobile Application
--   Date and Time:   19:05 Tuesday November 24, 2015
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,99838)
...
,p_authentication_id=>wwv_flow_api.id(35994468612190579337)
...
,p_last_upd_yyyymmddhh24miss=>'20151124185714'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(35994459620574579280)
,p_name=>'Mobile Navigation Menu'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(35994470489059579351)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(36800568699096711862)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(36802435819589927785)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(36811285774664551217)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(35994459357860579279)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(35994459475323579280)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(35994459603835579280)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(35994468509147579337)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(35994469660293579347)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35994459741505579281)
,p_theme_id=>51
,p_name=>'Dialog'
,p_is_popup=>true
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35994459927157579286)
,p_theme_id=>51
,p_name=>'Page'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35994460075347579286)
,p_page_template_id=>wwv_flow_api.id(35994459927157579286)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35994460130057579287)
,p_page_template_id=>wwv_flow_api.id(35994459927157579286)
,p_name=>'Header Bar'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35994460300350579287)
,p_page_template_id=>wwv_flow_api.id(35994459927157579286)
,p_name=>'Footer Bar'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35994460742562579290)
,p_theme_id=>51
,p_name=>'Popup'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(35994463169820579302)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(35994467336598579306)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35994460856390579292)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35994460958800579295)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35994461026993579295)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35994461206169579296)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35994461299923579296)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35994461393284579296)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35994461439703579296)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35994461552477579296)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35994461695940579296)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35994461763506579297)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35994461840127579297)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35994461969278579297)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35994462057735579297)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35994462129554579297)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35994462390957579298)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35994462429216579299)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35994462614953579299)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35994462715435579299)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35994462784617579300)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(35994462227896579297)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(35994462904759579300)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(35994462960105579301)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(35994463092121579301)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(35994467720522579317)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(35994467633523579306)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(35994468282927579331)
,p_theme_id=>51
,p_theme_name=>'Mobile'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(35994459927157579286)
,p_default_dialog_template=>wwv_flow_api.id(35994459741505579281)
,p_error_template=>wwv_flow_api.id(35994459927157579286)
,p_printer_friendly_template=>wwv_flow_api.id(35994459927157579286)
,p_login_template=>wwv_flow_api.id(35994459927157579286)
,p_default_button_template=>wwv_flow_api.id(35994467336598579306)
,p_default_region_template=>wwv_flow_api.id(35994461969278579297)
,p_default_chart_template=>wwv_flow_api.id(35994461969278579297)
,p_default_form_template=>wwv_flow_api.id(35994461969278579297)
,p_default_reportr_template=>wwv_flow_api.id(35994462129554579297)
,p_default_tabform_template=>wwv_flow_api.id(35994461969278579297)
,p_default_wizard_template=>wwv_flow_api.id(35994461969278579297)
,p_default_irr_template=>wwv_flow_api.id(35994461969278579297)
,p_default_report_template=>wwv_flow_api.id(35994462227896579297)
,p_default_label_template=>wwv_flow_api.id(35994462960105579301)
,p_default_calendar_template=>wwv_flow_api.id(35994467633523579306)
,p_default_list_template=>wwv_flow_api.id(35994462614953579299)
,p_default_nav_list_template=>wwv_flow_api.id(35994462429216579299)
,p_default_top_nav_list_temp=>wwv_flow_api.id(35994462614953579299)
,p_default_side_nav_list_temp=>wwv_flow_api.id(35994462784617579300)
,p_default_nav_list_position=>'TOP'
,p_default_dialogbtnr_template=>wwv_flow_api.id(35994460856390579292)
,p_default_dialogr_template=>wwv_flow_api.id(35994461969278579297)
,p_default_option_label=>wwv_flow_api.id(35994462960105579301)
,p_default_header_template=>wwv_flow_api.id(35994461695940579296)
,p_default_footer_template=>wwv_flow_api.id(35994461439703579296)
,p_default_required_label=>wwv_flow_api.id(35994463092121579301)
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(35994467851875579322)
,p_theme_id=>51
,p_name=>'Blue'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(35994468011819579323)
,p_theme_id=>51
,p_name=>'Dark'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(35994468034395579323)
,p_theme_id=>51
,p_name=>'Default'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(35994468147748579323)
,p_theme_id=>51
,p_name=>'Red'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(35994460326399579288)
,p_theme_id=>51
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(35994463306712579303)
,p_theme_id=>51
,p_name=>'ICON_BUTTON'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(35994463740675579304)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994460517665579289)
,p_theme_id=>51
,p_name=>'OVERLAY'
...
,p_group_id=>wwv_flow_api.id(35994460326399579288)
,p_template_types=>'PAGE'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994460595497579290)
,p_theme_id=>51
,p_name=>'PUSH'
,p_display_name=>'Push'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994460645882579290)
,p_theme_id=>51
,p_name=>'REVEAL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994463346690579303)
,p_theme_id=>51
,p_name=>'ICON_ACTION'
,p_display_name=>'Action'
,p_display_sequence=>100
,p_button_template_id=>wwv_flow_api.id(35994463169820579302)
,p_css_classes=>'ui-icon-action'
,p_group_id=>wwv_flow_api.id(35994463306712579303)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994463457842579303)
,p_theme_id=>51
,p_name=>'ICON_ALERT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994463612222579304)
,p_theme_id=>51
,p_name=>'ICON_BACK'
,p_display_name=>'Back'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994463672019579304)
,p_theme_id=>51
,p_name=>'ICON_BARS'
,p_display_name=>'Bars'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994463856190579304)
,p_theme_id=>51
,p_name=>'ICON_BOTTOM'
...
,p_group_id=>wwv_flow_api.id(35994463740675579304)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994464007893579304)
,p_theme_id=>51
,p_name=>'ICON_BULLETS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994464087619579304)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994464181652579304)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994464243806579304)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994464347118579304)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994464515911579304)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994464564907579304)
,p_theme_id=>51
,p_name=>'ICON_CHECK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994464663147579304)
,p_theme_id=>51
,p_name=>'ICON_CLOCK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994464760052579304)
,p_theme_id=>51
,p_name=>'ICON_CLOUD'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994464826045579304)
,p_theme_id=>51
,p_name=>'ICON_COMMENT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994464976560579304)
,p_theme_id=>51
,p_name=>'ICON_DELETE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994465096966579304)
,p_theme_id=>51
,p_name=>'ICON_EDIT'
,p_display_name=>'Edit'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994465184764579304)
,p_theme_id=>51
,p_name=>'ICON_GEAR'
,p_display_name=>'Gear'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994465245690579304)
,p_theme_id=>51
,p_name=>'ICON_GRID'
,p_display_name=>'Grid'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994465340546579305)
,p_theme_id=>51
,p_name=>'ICON_HOME'
,p_display_name=>'Home'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994465434464579305)
,p_theme_id=>51
,p_name=>'ICON_INFO'
,p_display_name=>'Info'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994465540441579305)
,p_theme_id=>51
,p_name=>'ICON_LEFT'
,p_display_name=>'Left'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994465625953579305)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994465760114579305)
,p_theme_id=>51
,p_name=>'ICON_LOCK'
,p_display_name=>'Lock'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994465822644579305)
,p_theme_id=>51
,p_name=>'ICON_MAIL'
,p_display_name=>'Mail'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994465935722579305)
,p_theme_id=>51
,p_name=>'ICON_MINUS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994466046139579305)
,p_theme_id=>51
,p_name=>'ICON_PHONE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994466215849579305)
,p_theme_id=>51
,p_name=>'ICON_PLUS'
,p_display_name=>'Plus'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994466313712579305)
,p_theme_id=>51
,p_name=>'ICON_POWER'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994466337216579305)
,p_theme_id=>51
,p_name=>'ICON_REFRESH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994466486821579305)
,p_theme_id=>51
,p_name=>'ICON_RIGHT'
,p_display_name=>'Right'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994466589296579305)
,p_theme_id=>51
,p_name=>'ICON_SEARCH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994466635202579306)
,p_theme_id=>51
,p_name=>'ICON_STAR'
,p_display_name=>'Star'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994466722496579306)
,p_theme_id=>51
,p_name=>'ICON_TAG'
,p_display_name=>'Tag'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994466894517579306)
,p_theme_id=>51
,p_name=>'ICON_TOP'
,p_display_name=>'Top'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994466950600579306)
,p_theme_id=>51
,p_name=>'ICON_USER'
,p_display_name=>'User'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994467092157579306)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994467191648579306)
,p_theme_id=>51
,p_name=>'NO_TEXT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994467286680579306)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994467464667579306)
,p_theme_id=>51
,p_name=>'INLINE_BUTTON'
,p_display_name=>'Inline Button'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(35994467336598579306)
,p_css_classes=>'ui-btn-inline'
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(35994467601523579306)
,p_theme_id=>51
,p_name=>'ROUNDED_CORNERS'
,p_display_name=>'Rounded Corners'
,p_display_sequence=>1
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(35994468612190579337)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(35994468408517579336)
,p_ui_type_name=>'JQM_SMARTPHONE'
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_api.id(35994459620574579280)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>wwv_flow_api.id(35994462784617579300)
...
wwv_flow_api.create_page(
 p_id=>0
,p_user_interface_id=>wwv_flow_api.id(35994468408517579336)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(35994469944579579349)
,p_plug_name=>'Header'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(35994461695940579296)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(35994470273196579349)
,p_plug_name=>'Footer'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(35994461439703579296)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(35994470182065579349)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(35994469944579579349)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(35994470037244579349)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(35994470334536579349)
,p_name=>'open panel'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(35994470037244579349)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(35994470334536579349)
,p_event_id=>wwv_flow_api.id(35994470334536579349)
,p_event_result=>'TRUE'
...
,p_name=>'RestfulReL'
,p_page_mode=>'NORMAL'
,p_step_title=>'Brave Frontier RESTful'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_page_template_options=>'#DEFAULT#'
,p_overwrite_navigation_list=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18190930047023172648)
,p_plug_name=>'New'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(35994461969278579297)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31799190183774155343)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31799190225953155344)
,p_plug_name=>'Unit Average Health'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_flash_chart5(
 p_id=>wwv_flow_api.id(31799190412680155345)
...
wwv_flow_api.create_flash_chart5_series(
 p_id=>wwv_flow_api.id(31799190440541155346)
,p_chart_id=>wwv_flow_api.id(31799190412680155345)
,p_series_seq=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(36800569086435711864)
,p_plug_name=>'doREST'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(35994461969278579297)
,p_plug_display_sequence=>20
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(36800587345101711884)
,p_name=>'Results'
,p_template=>wwv_flow_api.id(35994462129554579297)
,p_display_sequence=>50
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
,p_ajax_enabled=>'N'
,p_query_row_template=>wwv_flow_api.id(35994462227896579297)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(36802126164537052729)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(31799189999452155341)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(31799190104650155342)
,p_query_column_id=>3
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(36800569516784711868)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(36800569086435711864)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(36800569861265711869)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18190930124681172649)
,p_name=>'P5_NEW'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(18190930047023172648)
,p_source=>'http://bravefrontier.gumi.sg/assets/images/bflogo.png'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_DISPLAY_IMAGE'
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_api.id(35994462960105579301)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'URL'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36800580635457711873)
,p_name=>'P5_DB'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(36800569086435711864)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36800581496107711877)
,p_name=>'P5_USER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(36800569086435711864)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36800582284914711878)
,p_name=>'P5_PASS'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(36800569086435711864)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36800583085260711879)
,p_name=>'P5_MODE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(36800569086435711864)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36800583894440711879)
,p_name=>'P5_MODEL'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(36800569086435711864)
,p_item_default=>'C3'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36800584637989711880)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36800585483955711881)
,p_name=>'P5_RETURNFOR'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(36800569086435711864)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36800586294829711882)
,p_name=>'P5_QUERY'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(36800569086435711864)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(18425084078440003701)
,p_name=>'New'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(36800569516784711868)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18425084172906003702)
,p_event_id=>wwv_flow_api.id(18425084078440003701)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18425084271699003703)
,p_event_id=>wwv_flow_api.id(18425084078440003701)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_api.id(31799190183774155343)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(36800580291000711870)
...
,p_attribute_01=>wwv_flow_api.id(35994622656318759239)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(36802436179079927785)
,p_plug_name=>'UNITS'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(35994461969278579297)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(36802454452842927802)
,p_name=>'Results'
,p_template=>wwv_flow_api.id(35994462129554579297)
,p_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(36802455199912927810)
,p_query_column_id=>1
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(36802436592867927786)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(36802436179079927785)
,p_button_name=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(36802437007247927787)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31799190522050155347)
,p_name=>'DSCSDFDSFSDF'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(36802436179079927785)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36802437805239927791)
,p_name=>'P7_DB'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(36802436179079927785)
,p_prompt=>'Db'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36802438596427927795)
,p_name=>'P7_USER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(36802436179079927785)
,p_prompt=>'User'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36802439379834927796)
,p_name=>'P7_PASS'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(36802436179079927785)
,p_prompt=>'Pass'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36802450194646927797)
,p_name=>'P7_MODE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(36802436179079927785)
,p_prompt=>'Mode'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36802450957797927798)
,p_name=>'P7_MODEL'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(36802436179079927785)
,p_prompt=>'Model'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36802451774199927798)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36802452547985927799)
,p_name=>'P7_RETURNFOR'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(36802436179079927785)
,p_prompt=>'Returnfor'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36802453341491927800)
,p_name=>'P7_QUERY'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(36802436179079927785)
,p_prompt=>'Query'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(36802437406501927788)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_WEB_SERVICE'
,p_process_name=>'Web Service Request'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(36811409389827732030)
,p_plug_name=>'doREST'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(35994461969278579297)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(36811427918723732047)
,p_name=>'Results'
,p_template=>wwv_flow_api.id(35994462129554579297)
,p_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(36811428715453732053)
,p_query_column_id=>1
,p_column_alias=>'CLOB001'
,p_column_display_sequence=>1
,p_column_heading=>'Clob001'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(36811409757980732031)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(36811409389827732030)
,p_button_name=>'SUBMIT'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(35994467336598579306)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(36811420132601732033)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36811421140354732038)
,p_name=>'P10_DB'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(36811409389827732030)
,p_prompt=>'Db'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36811422001817732041)
,p_name=>'P10_USER'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(36811409389827732030)
,p_prompt=>'User'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36811422756067732042)
,p_name=>'P10_PASS'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(36811409389827732030)
,p_prompt=>'Pass'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36811423552146732042)
,p_name=>'P10_MODE'
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(36811409389827732030)
,p_prompt=>'Mode'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36811424368013732043)
,p_name=>'P10_MODEL'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(36811409389827732030)
,p_prompt=>'Model'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36811425191050732044)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36811425968730732045)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36811426785038732045)
,p_name=>'P10_QUERY'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(36811409389827732030)
,p_prompt=>'Query'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(36811420591765732034)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_WEB_SERVICE'
,p_process_name=>'Web Service Request'
...
,p_step_template=>wwv_flow_api.id(35994459927157579286)
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
,p_page_is_public_y_n=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(35994468849107579344)
,p_plug_name=>'Log In'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(35994461969278579297)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(35994469177048579346)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(35994468849107579344)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(35994467336598579306)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(35994468958540579345)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(35994468849107579344)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(35994469021933579346)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(35994469377000579347)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(35994469298464579347)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(35994469549289579347)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(35994469511992579347)
,p_process_sequence=>10
...
wwv_flow_api.create_web_service(
 p_id=>wwv_flow_api.id(35994622515049759237)
,p_name=>'RestfulReL'
...
wwv_flow_api.create_ws_operations(
 p_id=>wwv_flow_api.id(35994622656318759239)
,p_ws_id=>wwv_flow_api.id(35994622515049759237)
,p_name=>'doREST'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(35994622942166759243)
,p_ws_opers_id=>wwv_flow_api.id(35994622656318759239)
,p_name=>'query'
,p_input_or_output=>'I'
,p_parm_type=>'string'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36800586710140711882)
,p_parameter_id=>wwv_flow_api.id(35994622942166759243)
,p_process_id=>wwv_flow_api.id(36800580291000711870)
,p_map_type=>'ITEM'
,p_parm_value=>'P5_QUERY'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36802453811308927800)
,p_parameter_id=>wwv_flow_api.id(35994622942166759243)
,p_process_id=>wwv_flow_api.id(36802437406501927788)
,p_map_type=>'ITEM'
,p_parm_value=>'P7_QUERY'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36811427121498732046)
,p_parameter_id=>wwv_flow_api.id(35994622942166759243)
,p_process_id=>wwv_flow_api.id(36811420591765732034)
,p_map_type=>'ITEM'
,p_parm_value=>'P10_QUERY'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(35994623262365759246)
,p_ws_opers_id=>wwv_flow_api.id(35994622656318759239)
,p_name=>'json'
,p_input_or_output=>'O'
,p_parm_type=>'json'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(35994650844436601332)
,p_ws_opers_id=>wwv_flow_api.id(35994622656318759239)
,p_name=>'DB'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36800581072785711875)
,p_parameter_id=>wwv_flow_api.id(35994650844436601332)
,p_process_id=>wwv_flow_api.id(36800580291000711870)
,p_map_type=>'ITEM'
,p_parm_value=>'P5_DB'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36802438195907927794)
,p_parameter_id=>wwv_flow_api.id(35994650844436601332)
,p_process_id=>wwv_flow_api.id(36802437406501927788)
,p_map_type=>'ITEM'
,p_parm_value=>'P7_DB'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36811421525727732040)
,p_parameter_id=>wwv_flow_api.id(35994650844436601332)
,p_process_id=>wwv_flow_api.id(36811420591765732034)
,p_map_type=>'ITEM'
,p_parm_value=>'P10_DB'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(35994651197263601333)
,p_ws_opers_id=>wwv_flow_api.id(35994622656318759239)
,p_name=>'USER'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36800581854801711877)
,p_parameter_id=>wwv_flow_api.id(35994651197263601333)
,p_process_id=>wwv_flow_api.id(36800580291000711870)
,p_map_type=>'ITEM'
,p_parm_value=>'P5_USER'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36802439003990927796)
,p_parameter_id=>wwv_flow_api.id(35994651197263601333)
,p_process_id=>wwv_flow_api.id(36802437406501927788)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36811422381814732041)
,p_parameter_id=>wwv_flow_api.id(35994651197263601333)
,p_process_id=>wwv_flow_api.id(36811420591765732034)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(35994651481979601333)
,p_ws_opers_id=>wwv_flow_api.id(35994622656318759239)
,p_name=>'PASS'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36800582668256711878)
,p_parameter_id=>wwv_flow_api.id(35994651481979601333)
,p_process_id=>wwv_flow_api.id(36800580291000711870)
,p_map_type=>'ITEM'
,p_parm_value=>'P5_PASS'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36802439805397927796)
,p_parameter_id=>wwv_flow_api.id(35994651481979601333)
,p_process_id=>wwv_flow_api.id(36802437406501927788)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36811423212394732042)
,p_parameter_id=>wwv_flow_api.id(35994651481979601333)
,p_process_id=>wwv_flow_api.id(36811420591765732034)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(35994651817032601333)
,p_ws_opers_id=>wwv_flow_api.id(35994622656318759239)
,p_name=>'MODE'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36800583499043711879)
,p_parameter_id=>wwv_flow_api.id(35994651817032601333)
,p_process_id=>wwv_flow_api.id(36800580291000711870)
,p_map_type=>'ITEM'
,p_parm_value=>'P5_MODE'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36802450598275927797)
,p_parameter_id=>wwv_flow_api.id(35994651817032601333)
,p_process_id=>wwv_flow_api.id(36802437406501927788)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36811423958381732043)
,p_parameter_id=>wwv_flow_api.id(35994651817032601333)
,p_process_id=>wwv_flow_api.id(36811420591765732034)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(35994652070865601333)
,p_ws_opers_id=>wwv_flow_api.id(35994622656318759239)
,p_name=>'MODEL'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36800584270616711880)
,p_parameter_id=>wwv_flow_api.id(35994652070865601333)
,p_process_id=>wwv_flow_api.id(36800580291000711870)
,p_map_type=>'ITEM'
,p_parm_value=>'P5_MODEL'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36802451328900927798)
,p_parameter_id=>wwv_flow_api.id(35994652070865601333)
,p_process_id=>wwv_flow_api.id(36802437406501927788)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36811424727806732044)
,p_parameter_id=>wwv_flow_api.id(35994652070865601333)
,p_process_id=>wwv_flow_api.id(36811420591765732034)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(35994652383128601334)
,p_ws_opers_id=>wwv_flow_api.id(35994622656318759239)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36800585090737711881)
,p_parameter_id=>wwv_flow_api.id(35994652383128601334)
,p_process_id=>wwv_flow_api.id(36800580291000711870)
,p_map_type=>'ITEM'
,p_parm_value=>'P5_RETURNDIMENSIONS'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36802452174536927799)
,p_parameter_id=>wwv_flow_api.id(35994652383128601334)
,p_process_id=>wwv_flow_api.id(36802437406501927788)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36811425606134732044)
,p_parameter_id=>wwv_flow_api.id(35994652383128601334)
,p_process_id=>wwv_flow_api.id(36811420591765732034)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(35994652678724601334)
,p_ws_opers_id=>wwv_flow_api.id(35994622656318759239)
,p_name=>'returnFor'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36800585830162711882)
,p_parameter_id=>wwv_flow_api.id(35994652678724601334)
,p_process_id=>wwv_flow_api.id(36800580291000711870)
,p_map_type=>'ITEM'
,p_parm_value=>'P5_RETURNFOR'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36802452956799927799)
,p_parameter_id=>wwv_flow_api.id(35994652678724601334)
,p_process_id=>wwv_flow_api.id(36802437406501927788)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(36811426373934732045)
,p_parameter_id=>wwv_flow_api.id(35994652678724601334)
,p_process_id=>wwv_flow_api.id(36811420591765732034)
,p_map_type=>'ITEM'
