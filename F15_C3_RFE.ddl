...
ALTER TABLE Relation_11 ADD CONSTRAINT FK_ASS_2 FOREIGN KEY ( F15_C3_RFE_ref_id ) REFERENCES F15_C3_RFE ( ref_id ) ;

ALTER TABLE Relation_11 ADD CONSTRAINT FK_ASS_3 FOREIGN KEY ( F15_C3_Comment_comment_id ) REFERENCES F15_C3_Comment ( comment_id ) ;
